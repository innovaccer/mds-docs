    ...
    <Tab label="Status">
      ...
      <Card shadow='none'>
        <Table
          ...
          data={[
            {"name": "Avatar","design": "Unavailable", "code":"Unavailable" }, 
            {"name": "Badges","design": "Unavailable", "code":"Unavailable" }, 
            {"name": "Breadcrumb","design": "Unavailable", "code":"Unavailable" },
            {"name": "Buttons","design": "Available", "code":"Available" },  
            {"name": "Card","design": "Unavailable", "code":"Unavailable" }, 
            {"name": "Checkbox","design": "Beta", "code":"Unavailable" }, 
            {"name": "Chips","design": "Unavailable", "code":"Unavailable" }, 
            {"name": "Date and Time picker","design": "Unavailable", "code": "Unavailable" }, 
            {"name": "Dropdown","design": "Unavailable", "code": "Unavailable" } 
          ]}
          schema={[
            {
              name: 'name', 
              ...
              cellRenderer: ({data}) => {
                return(
                  <Text appearance="link">{data.name}</Text>
                )
              }
            },
            {
