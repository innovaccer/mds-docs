...
import Tabbed from '../../../gatsby-theme-mds/src/components/Tabs/Tabs.js';
import TabCmp1 from './tabcmp1';
import TabCmp2 from './tabcmp2';
...
<Tabbed
  tabData={[
    { tabName: 'tab 1', data: TabCmp1 },
    { tabName: 'tab 2', data: TabCmp2 },
  ]}
/>
